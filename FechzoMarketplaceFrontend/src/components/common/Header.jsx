...
export default function Header() {
  ...
  // ============================================================
  // LOAD LOGGED-IN USER (more reliable)
  // ============================================================
  const loadUser = () => {
    try {
      ...
      if (token && storedUser) {
        ...
        setUser(parsedUser);
        console.log("✅ User loaded in Header:", parsedUser);
      } else {
        setUser(null);
      }
    } catch (error) {
  ...
  useEffect(() => {
    ...
    // 3. Safety net – check again after a short delay
    //    (helps when App.jsx saves the data slightly later)
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {user ? (
              <div className="relative profile-dropdown">
                ...
                >
                  <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-gradient-to-br from-[#1e3a8a] to-[#02066f] text-white flex items-center justify-center font-bold text-sm shadow-md overflow-hidden">
                  ...
                  <div className="absolute right-0 mt-2 w-64 bg-white rounded-2xl border border-slate-200 shadow-2xl overflow-hidden z-[100]">
                    <div className="px-4 py-4 bg-gradient-to-br from-slate-50 to-white border-b border-slate-100">
                      <div className="flex items-center gap-3">
                        <div className="w-11 h-11 rounded-full bg-gradient-to-br from-[#1e3a8a] to-[#02066f] text-white flex items-center justify-center font-bold overflow-hidden">
                          {user.profileImage || user.avatar ? (
                            <img
                              src={user.profileImage || user.avatar}
                              alt={getUserName()}
