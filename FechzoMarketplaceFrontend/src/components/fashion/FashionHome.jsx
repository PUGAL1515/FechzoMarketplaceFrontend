        ...
        <div className="mx-auto flex min-h-[390px] max-w-[1400px] items-center justify-between px-6 py-14 lg:px-12">
          ...
          <div className="max-w-2xl">
            ...
            <p className="mt-5 max-w-xl text-base leading-7 text-gray-500 sm:text-lg">
              Discover the latest styles, trending fashion
              and everyday essentials for everyone.
            </p>
        ...
        <div className="mx-auto max-w-[1400px] px-5 sm:px-8 lg:px-10">
          ...
          <div className="mb-9">
            ...
            <p className="mt-2 text-sm text-gray-500">
              Find styles for every occasion and everyone.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-5">
            ...
            {categories.map((item) => {
              ...
              return (
                <Link
                  key={item.name}
                  to={`/fashion/products?category=${item.name}`}
