...
export default function StoreAdmin() {
   ...
   * =========================================================
   */
  const handleNavigation = (page, action = null, product = null) => {
    setActivePage(page);
   ...
   * =========================================================
   */
  const StoreLogo = ({ size = "normal" }) => {
    const classes =
      size === "large" ? "w-14 h-14 rounded-xl" : "w-10 h-10 rounded-xl";
    ...
    return (
      <div
        className={`${classes} bg-linear-to-br from-blue-600 to-indigo-700 flex items-center justify-center`}
      >
        <Store className="text-white" size={size === "large" ? 28 : 21} />
      </div>
    );
  };
  ...
  const renderPage = () => {
    if (activePage === "dashboard") {
      return (
        <StoreDashboard store={store} onNavigate={handleNavigation} />
      );
    }
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-11 h-11 rounded-xl bg-purple-50 flex items-center justify-center">
                <Tags size={22} className="text-purple-600" />
              </div>
      ...
      <main className="lg:ml-64 min-h-screen">
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="text-left">
                  <p className="text-sm font-bold text-gray-900 max-w-42.5 truncate">
                    {store?.storeName || "Store Admin"}
                  </p>
                  <p className="text-xs text-gray-500 capitalize">
              ...
              {profileOpen && (
                <div className="absolute right-0 top-14 w-72 bg-white rounded-2xl border border-gray-200 shadow-xl overflow-hidden z-50">
                  <div className="p-4 bg-linear-to-r from-blue-600 to-indigo-700 text-white">
        ...
        {activePage === "dashboard" && (
          <div className="px-4 md:px-6 lg:px-8 pt-5">
            <div className="relative overflow-hidden rounded-2xl bg-linear-to-r from-blue-700 via-blue-600 to-indigo-700 text-white shadow-lg">
                ...
                <div className="flex items-center gap-4">
                  {store?.logo ? (
                    ...
                    <div className="w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-white/15 flex items-center justify-center border border-white/20">
                      <Store size={35} className="text-white" />
                    </div>
                  )}
                  ...
                  <div>
                    ...
                    <p className="text-blue-100/80 text-xs mt-1">
                      Welcome back, @{store?.username || "seller"}
                    </p>
                  </div>
                </div>
